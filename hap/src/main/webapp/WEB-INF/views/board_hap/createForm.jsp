	...
	<div class="container">
		...
		<form class="form-horizontal" action="create" method="post" name='frm'
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="sample6_address"
						placeholder="주소" name="board_address">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="file" class="form-control" id="board_map"
						name="board_mapMF" accept=".jpg,.gif,.png">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="board_content"
						placeholder="숙소 정보를 입력하세요" name="board_content">
				</div>
			</div>
